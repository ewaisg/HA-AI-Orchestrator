...
| Field | Current value |
|---|---|
| Last completed | LOC-006 live chat generation acceptance: real reply, context-bearing follow-up, New chat reset, provider test, and catalogue health all verified against the owner's Core 2026.9.0. Evidence: `docs/evidence/2026-09-05-loc-006-local-chat.md`. |
| Active work | LOC-007 Phase 1 release gate, gated on LOC-003/004/005 and COMP-001 remaining named live acceptance items (reload/unload/restart, desktop/Android rendering, catalogue mutation/rename/removal checks). |
| Evidence/input needed | LOC-003/004/005 still need reload/unload/restart, bounded-failure, desktop/Android, and scoped-log evidence beyond what is already recorded. COMP-001 still needs live restart/panel/lifecycle/Android acceptance on Core 2026.9.0. First isolated backup restore artifact remains due by 2027-02-23 or earlier after a major change. |
| Next gate | Complete the remaining LOC-003/004/005/COMP-001 live items, then run the LOC-007 quality/redaction/smoke gate. |
