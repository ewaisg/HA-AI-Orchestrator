...
Current resume point: **LOC-002 candidate `4de9a453b353e63332251869b31d6f6c05dee13b` was rejected by independent workflow/safety review at `2026-08-24T07:31:55Z`. The prior two P1 findings are resolved, but continuation history still accepts an unexposed historical tool, schema-invalid historical arguments, and duplicate tool definitions. Remediate only the provider contract, direct/runtime tests, and LOC-002 evidence metadata; verify the provider, focused, pure, Ruff, canary, traceability, manifest-schema, diff, and clean-worktree gates from a new immutable candidate, then obtain fresh workflow/safety and test/release approvals. No endpoint, credential, network transport, tool executor, or Home Assistant action is authorized.**
...
| LOC-002 | Define provider contract and normalized errors/capabilities | `IN PROGRESS` | FND-008 | Candidate `4de9a453b353e63332251869b31d6f6c05dee13b` was rejected by workflow/safety at `2026-08-24T07:31:55Z`: continuation history validates correlation IDs but not unique exposed tool definitions or historical argument schemas. Expected files: `providers/contract.py`, direct/runtime provider tests, and LOC-002 tracker/evidence/manifest metadata. Required verification: provider/focused/pure suites, Ruff, canary, traceability, manifest-schema, diff/clean tree, then fresh independent workflow/safety and test/release reviews. Evidence: `docs/evidence/2026-08-24-loc-002-provider-contract.md` |
