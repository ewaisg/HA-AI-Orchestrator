...
Current resume point: **LOC-001 immutable artifact `4ea2595029e7ad7a953abb628bf38bd93060885f` passes 223 clean-Linux full-suite tests from a Git archive, 166 provider/security/quality tests, 166 pure tests, Ruff, canary, manifest-schema, traceability, diff, hash, and clean-worktree checks. Commit the metadata candidate, then obtain independent workflow/safety and test/release approvals. No LM Studio transport, endpoint, credential, model, provider UI, or Home Assistant action is present.**
...
|---|---|---|---|---|
| LOC-001 | Complete local provider connection lifecycle on the validated skeleton | `REVIEW` | FND-010, LOC-002 | Artifact `4ea2595029e7ad7a953abb628bf38bd93060885f` implements closed foundation/provider entry shapes, adapter-owned setup/reauth/reconfigure schemas, validation before save/update, safe normalized HA failure mapping, entry-local runtime, unload/removal, and fail-closed v1 foundation migration. Exact committed checks: 223 clean-Linux full, 166 provider/security/quality, and 166 pure tests plus Ruff, canary, manifest-schema, traceability, hash, diff, and clean tree. Next: metadata candidate and independent reviews. Evidence: `docs/evidence/2026-08-24-loc-001-provider-entry-lifecycle.md`. |
