...
Current resume point: **LOC-002 remediated artifact `9b5bd56667c27564244b456b7416ca125845db4e` is in REVIEW after independent workflow/safety rejection of the earlier candidate `e8a5acd2a99c8cb446e924bd75e8dccf9fc202a1`. The two P1 findings are remediated: structured tool-call/result IDs are correlated and the every-adapter provider control/test is restored to design/planned. The replacement adds a closed structured/tool schema dialect, fixed safe error text, nineteen committed zero-network fixtures, explicit negative/common-suite cases, and reproduces 160 focused/pure tests, Ruff, canary, traceability, manifest-schema, diff, and clean-worktree gates from the exact commit. Commit the replacement metadata candidate and resubmit independent reviews. No endpoint, credential, network transport, tool executor, or Home Assistant action is authorized.**
...
| LOC-002 | Define provider contract and normalized errors/capabilities | `REVIEW` | FND-008 | Earlier candidate `e8a5acd2a99c8cb446e924bd75e8dccf9fc202a1` rejected by workflow/safety. Remediated artifact `9b5bd56667c27564244b456b7416ca125845db4e` resolves both P1 findings with correlated tool continuation, closed schema validation, fixed safe errors, nineteen committed fixtures, negative/common-suite cases, and traceability restored to design/planned until live adapters run it. Exact committed local gates passed 160 focused/pure tests plus Ruff, canary, traceability, manifest-schema, diff, and clean worktree. Next: replacement metadata candidate and fresh independent reviews. Evidence: `docs/evidence/2026-08-24-loc-002-provider-contract.md` |
