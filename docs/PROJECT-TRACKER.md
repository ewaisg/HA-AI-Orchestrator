...
Current resume point: **LOC-001 workflow/safety re-review rejected candidate `29c7db552aea270b796057475ec8078eaa75a119` at `2026-08-24T17:11:01Z` because a forged error-code object could throw from hashing before the safe fallback. The working tree now type-checks `ErrorCode` before every mapping/set lookup and adds setup, initial configuration, reauthentication, and reconfiguration adversarial tests; 54 focused clean-Linux tests and 167 local provider/security/quality plus 167 pure tests pass. Create a new immutable artifact, reproduce all gates, and repeat both reviews. No LM Studio transport, endpoint, credential, model, provider UI, or Home Assistant action is present.**
...
|---|---|---|---|---|
| LOC-001 | Complete local provider connection lifecycle on the validated skeleton | `REVIEW` | FND-010, LOC-002 | First candidate rejected four boundary flaws; artifact `623d61b6d8dffa5ce00a5f1e5c38f51e938a5351` fixed them and test/release approved `2026-08-24T17:09:53Z`, but workflow/safety rejected `2026-08-24T17:11:01Z` because forged error-code hashing could still escape. The current tree validates `ErrorCode` before hashing and adds four flow/setup regression cases; 54 focused clean-Linux, 167 local provider/security/quality, 167 pure, Ruff, canary, and diff pass. Next: new immutable artifact, full exact gates, and fresh reviews. Evidence: `docs/evidence/2026-08-24-loc-001-provider-entry-lifecycle.md`. |
