...
Current resume point: **LOC-001 remediated immutable artifact `623d61b6d8dffa5ce00a5f1e5c38f51e938a5351` passes 238 full, 50 focused lifecycle, 137 provider, 30 security/evidence/traceability, and 167 pure tests in clean Linux, plus Ruff, canary, canonical hashes, diff, schema, and traceability. The prior workflow/safety rejection remains recorded; obtain fresh workflow/safety and test/release approvals for this exact artifact. No LM Studio transport, endpoint, credential, model, provider UI, or Home Assistant action is present.**
...
|---|---|---|---|---|
| LOC-001 | Complete local provider connection lifecycle on the validated skeleton | `REVIEW` | FND-010, LOC-002 | Candidate `5c260ae5cfb46a497db3be322fbd621e5a31baeb` was workflow/safety-rejected `2026-08-24T16:49:22Z` for four boundary flaws. Remediated artifact `623d61b6d8dffa5ce00a5f1e5c38f51e938a5351` fixes all four with adversarial tests and passes exact clean-Linux 238 full, 50 focused, 137 provider, 30 security/evidence/traceability, and 167 pure tests plus Ruff, canary, hashes, schema, traceability, and diff. Next: fresh independent reviews of the remediated artifact. Evidence: `docs/evidence/2026-08-24-loc-001-provider-entry-lifecycle.md`. |
