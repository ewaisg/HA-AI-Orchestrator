...
Current resume point: **FND-013 remains in REVIEW. Corrected committed artifact revision `a7495b08c42c395cb15f6a30fb4956d38b091b53` contains the redacted map/catalog/schema/tests and canonical LF evidence hashes. It resolves all earlier safety/reproducibility findings and the final readable-map drift by fully expanding every requirement row and mechanically requiring exact row-level equality with the machine catalog. Checks: 88 pure tests, seven focused integrity tests, 23 focused-plus-schema tests, Ruff, canary, diff, privacy, and working/index hash equality passed. The incomplete manifest points to that clean revision with `dirty: false`; fresh workflow/safety and test/release reviews are pending. FND-011 remains open only for an actual Core upgrade artifact, so FND-010 cannot close yet. Do not begin LOC-001 until FND-010 passes.**
...
| FND-013 | Define data-flow and control-to-test traceability records | Security + tracker | `REVIEW` | FND-007 | Corrected clean artifact revision `a7495b08c42c395cb15f6a30fb4956d38b091b53`: 7 data classes, 13 nodes, 18 flows, 19 requirements, 19 controls, 23 tests; all safety/reproducibility findings corrected, including exact readable/catalog requirement-row equality. 88 pure tests, seven focused integrity tests, and 23 focused-plus-schema tests passed; Ruff/canary/diff/privacy/hash checks passed. Manifest is committed-source, clean, and incomplete pending fresh independent approvals |
