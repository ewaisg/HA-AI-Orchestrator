...
Current resume point: **LOC-001 exact-type artifact `9dd98896fc61b8b6ff35aa5b032f5b6e13286926` uses `type(code) is ErrorCode` and tests setup, initial setup, reauth, and reconfigure against genuinely unhashable, throwing-hash, and type-spoofing throwing-hash codes. Exact clean Linux passes 250 full, 62 focused lifecycle, 137 provider, 30 security/evidence/traceability, and 167 pure tests plus Ruff, canary, hashes, schema, traceability, and diff. Obtain fresh independent workflow/safety and test/release approvals. No LM Studio transport, endpoint, credential, model, provider UI, or Home Assistant action is present.**
...
|---|---|---|---|---|
| LOC-001 | Complete local provider connection lifecycle on the validated skeleton | `REVIEW` | FND-010, LOC-002 | Prior candidates were rejected and remain unaccepted. Exact-type artifact `9dd98896fc61b8b6ff35aa5b032f5b6e13286926` uses non-dispatching type identity and exercises unhashable, throwing-hash, and type-spoofing throwing-hash codes across all four lifecycle paths. Exact clean Linux passes 250 full, 62 focused, 137 provider, 30 security/evidence/traceability, and 167 pure tests plus Ruff, canary, hashes, schema, traceability, and diff. Next: fresh independent reviews. Evidence: `docs/evidence/2026-08-24-loc-001-provider-entry-lifecycle.md`. |
