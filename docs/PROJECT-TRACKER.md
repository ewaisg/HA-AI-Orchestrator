...
Current resume point: **LOC-001 workflow/safety review rejected candidate `5c260ae5cfb46a497db3be322fbd621e5a31baeb` at `2026-08-24T16:49:22Z` for four shared-lifecycle boundary flaws. The working-tree remediation enforces normalized-error construction and fixed HA messages, bounds schema callback failures, separates validated configuration from adapter-mutated copies, recursively rejects lossy JSON shapes, and rejects unsupported major/minor migrations. Focused clean-Linux tests pass 50; local provider/security/quality and pure suites pass 167 each. Create and verify a new immutable artifact, then repeat both independent reviews. No LM Studio transport, endpoint, credential, model, provider UI, or Home Assistant action is present.**
...
|---|---|---|---|---|
| LOC-001 | Complete local provider connection lifecycle on the validated skeleton | `REVIEW` | FND-010, LOC-002 | Candidate `5c260ae5cfb46a497db3be322fbd621e5a31baeb`: test/release approved `2026-08-24T16:47:18Z`; workflow/safety rejected `2026-08-24T16:49:22Z` for forged-error/schema text exposure, adapter mutation after validation, lossy nested JSON shapes, and unsupported migration versions. All four are remediated in the current tree with adversarial tests; focused clean-Linux 50, local provider/security/quality 167, pure 167, Ruff, canary, and diff pass. Next: new immutable artifact, exact full gates, and repeat both reviews. Evidence: `docs/evidence/2026-08-24-loc-001-provider-entry-lifecycle.md`. |
