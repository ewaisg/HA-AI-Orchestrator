...
| Next gate | Complete remaining redacted live acceptance on Core 2026.8.3: invalid credentials, duplicate clicks, reload/unload/restart, Companion Android, screenshots, and scoped logs |
