...
| FLOW-012 | HA → notification/media/voice output | Deterministic alert or approved communication leaves HA | CTRL-AUTH-001, CTRL-ALERT-001, CTRL-ACTION-001, CTRL-IDEMPOTENCY-001, CTRL-RATE-001 | TEST-AUTHORIZATION-MATRIX, TEST-DETERMINISTIC-ALERT, TEST-ACTION-CONFIRMATION, TEST-IDEMPOTENT-RESTART, TEST-STORM-CONCURRENCY |
...
All rows remain `planned`. The IDs map the approved source text; they do not replace it. IDs are fully expanded so the integrity suite can compare every readable row exactly with the machine catalog.

| Requirement | Short meaning | Primary flows | Primary controls | Acceptance tests |
|---|---|---|---|---|
| REQ-CAP-001 | UI-configured provider connections behind one contract | FLOW-001, FLOW-003, FLOW-005, FLOW-006, FLOW-007, FLOW-008, FLOW-009 | CTRL-AUTH-001, CTRL-SECRET-001, CTRL-ENDPOINT-001, CTRL-PROVIDER-001, CTRL-RATE-001, CTRL-SUPPLY-CHAIN-001 | TEST-AUTHORIZATION-MATRIX, TEST-SECRET-EGRESS, TEST-ENDPOINT-SSRF, TEST-PROVIDER-CONTRACT, TEST-STORM-CONCURRENCY, TEST-DEPENDENCY-REVIEW |
| REQ-CAP-002 | Live HA entity/device/area/state/action discovery | FLOW-004, FLOW-011 | CTRL-AUTH-001, CTRL-PRIVACY-001, CTRL-RED-001 | TEST-AUTHORIZATION-MATRIX, TEST-CLOUD-PRIVACY, TEST-REDACTION-CANARY |
| REQ-CAP-003 | Per-agent/workflow observation/action/privacy/confirmation scopes | FLOW-003, FLOW-004, FLOW-005, FLOW-010, FLOW-015 | CTRL-AUTH-001, CTRL-PRIVACY-001, CTRL-INPUT-TRUST-001, CTRL-TOOL-001, CTRL-ACTION-001 | TEST-AUTHORIZATION-MATRIX, TEST-CLOUD-PRIVACY, TEST-PROMPT-INJECTION, TEST-TOOL-ALLOWLIST, TEST-ACTION-CONFIRMATION, TEST-DEVICE-SIDE-EFFECT |
| REQ-CAP-004 | Visual deterministic workflow with constrained AI and failures | FLOW-004, FLOW-005, FLOW-006, FLOW-007, FLOW-008, FLOW-009, FLOW-010, FLOW-015 | CTRL-INPUT-TRUST-001, CTRL-OUTPUT-001, CTRL-TOOL-001, CTRL-ACTION-001, CTRL-IDEMPOTENCY-001, CTRL-RATE-001, CTRL-COMPAT-001, CTRL-UPGRADE-001 | TEST-PROMPT-INJECTION, TEST-OUTPUT-SCHEMA, TEST-TOOL-ALLOWLIST, TEST-ACTION-CONFIRMATION, TEST-IDEMPOTENT-RESTART, TEST-STORM-CONCURRENCY, TEST-DEVICE-SIDE-EFFECT, TEST-COMPAT-LIFECYCLE, TEST-COMPAT-CORE-UPGRADE |
| REQ-CAP-005 | Compose/classify/extract/branch/bounded conversation-tool modes | FLOW-006, FLOW-007, FLOW-008, FLOW-009 | CTRL-PROVIDER-001, CTRL-INPUT-TRUST-001, CTRL-OUTPUT-001, CTRL-TOOL-001 | TEST-PROVIDER-CONTRACT, TEST-PROMPT-INJECTION, TEST-OUTPUT-SCHEMA, TEST-TOOL-ALLOWLIST |
| REQ-CAP-006 | Chat and Assist conversation agent | FLOW-001, FLOW-003, FLOW-004, FLOW-006, FLOW-007, FLOW-008, FLOW-009, FLOW-011 | CTRL-AUTH-001, CTRL-PRIVACY-001, CTRL-INPUT-TRUST-001, CTRL-PROVIDER-001, CTRL-TOOL-001, CTRL-RETENTION-001 | TEST-AUTHORIZATION-MATRIX, TEST-CLOUD-PRIVACY, TEST-PROMPT-INJECTION, TEST-PROVIDER-CONTRACT, TEST-TOOL-ALLOWLIST, TEST-RETENTION-DELETION |
| REQ-CAP-007 | Live-available HA announcements/notifications | FLOW-004, FLOW-010, FLOW-012 | CTRL-AUTH-001, CTRL-ACTION-001, CTRL-IDEMPOTENCY-001, CTRL-RATE-001 | TEST-AUTHORIZATION-MATRIX, TEST-ACTION-CONFIRMATION, TEST-IDEMPOTENT-RESTART, TEST-STORM-CONCURRENCY |
| REQ-CAP-008 | Named routes, health, safe failover, visible destination | FLOW-006, FLOW-007, FLOW-008, FLOW-009, FLOW-011 | CTRL-PRIVACY-001, CTRL-INPUT-TRUST-001, CTRL-ENDPOINT-001, CTRL-PROVIDER-001, CTRL-IDEMPOTENCY-001, CTRL-RATE-001 | TEST-CLOUD-PRIVACY, TEST-PROMPT-INJECTION, TEST-ENDPOINT-SSRF, TEST-PROVIDER-CONTRACT, TEST-IDEMPOTENT-RESTART, TEST-STORM-CONCURRENCY |
| REQ-CAP-009 | Dry run, exact context preview, redacted trace, restart safety | FLOW-003, FLOW-005, FLOW-010, FLOW-011, FLOW-013 | CTRL-RED-001, CTRL-PRIVACY-001, CTRL-INPUT-TRUST-001, CTRL-IDEMPOTENCY-001, CTRL-RETENTION-001, CTRL-COMPAT-001, CTRL-UPGRADE-001 | TEST-REDACTION-CANARY, TEST-CLOUD-PRIVACY, TEST-PROMPT-INJECTION, TEST-IDEMPOTENT-RESTART, TEST-RETENTION-DELETION, TEST-COMPAT-LIFECYCLE, TEST-COMPAT-CORE-UPGRADE |
| REQ-CAP-010 | AI cannot replace life-safety detection or unrestricted action policy | FLOW-004, FLOW-010, FLOW-012, FLOW-015 | CTRL-INPUT-TRUST-001, CTRL-TOOL-001, CTRL-ACTION-001, CTRL-ALERT-001, CTRL-IDEMPOTENCY-001, CTRL-RATE-001 | TEST-PROMPT-INJECTION, TEST-TOOL-ALLOWLIST, TEST-ACTION-CONFIRMATION, TEST-DETERMINISTIC-ALERT, TEST-IDEMPOTENT-RESTART, TEST-STORM-CONCURRENCY, TEST-DEVICE-SIDE-EFFECT |
| REQ-CON-001 | Private personal-use distribution | FLOW-001, FLOW-002, FLOW-003 | CTRL-AUTH-001, CTRL-COMPAT-001, CTRL-UPGRADE-001, CTRL-SUPPLY-CHAIN-001 | TEST-AUTHORIZATION-MATRIX, TEST-COMPAT-LIFECYCLE, TEST-COMPAT-CORE-UPGRADE, TEST-DEPENDENCY-REVIEW |
| REQ-CON-002 | HA is authoritative for state and action | FLOW-004, FLOW-010, FLOW-012, FLOW-015 | CTRL-AUTH-001, CTRL-ACTION-001, CTRL-COMPAT-001, CTRL-UPGRADE-001 | TEST-AUTHORIZATION-MATRIX, TEST-ACTION-CONFIRMATION, TEST-DEVICE-SIDE-EFFECT, TEST-COMPAT-LIFECYCLE, TEST-COMPAT-CORE-UPGRADE |
| REQ-CON-003 | Newly typed secret is transient; stored credentials never return to browser; provider requests are backend-only | FLOW-001, FLOW-002, FLOW-003, FLOW-006, FLOW-007 | CTRL-SECRET-001, CTRL-ENDPOINT-001 | TEST-NO-BROWSER-PROVIDER, TEST-SECRET-EGRESS, TEST-ENDPOINT-SSRF |
| REQ-CON-004 | No generic unrestricted model action tool | FLOW-008, FLOW-009, FLOW-010, FLOW-015 | CTRL-INPUT-TRUST-001, CTRL-TOOL-001, CTRL-ACTION-001 | TEST-PROMPT-INJECTION, TEST-TOOL-ALLOWLIST, TEST-ACTION-CONFIRMATION, TEST-DEVICE-SIDE-EFFECT |
| REQ-CON-005 | No cloud disclosure without workflow authorization | FLOW-007, FLOW-009, FLOW-011 | CTRL-PRIVACY-001, CTRL-INPUT-TRUST-001, CTRL-RED-001 | TEST-CLOUD-PRIVACY, TEST-PROMPT-INJECTION, TEST-REDACTION-CANARY |
| REQ-CON-006 | YAML is not the primary UX | FLOW-001, FLOW-003, FLOW-005, FLOW-011 | CTRL-AUTH-001, CTRL-OUTPUT-001, CTRL-COMPAT-001, CTRL-UPGRADE-001 | TEST-AUTHORIZATION-MATRIX, TEST-OUTPUT-SCHEMA, TEST-COMPAT-LIFECYCLE, TEST-COMPAT-CORE-UPGRADE |
| REQ-CON-007 | No unverified capability claim | FLOW-004, FLOW-006, FLOW-007, FLOW-008, FLOW-009 | CTRL-PROVIDER-001, CTRL-COMPAT-001, CTRL-UPGRADE-001 | TEST-PROVIDER-CONTRACT, TEST-COMPAT-LIFECYCLE, TEST-COMPAT-CORE-UPGRADE, TEST-LOCAL-AUTH-NETWORK |
| REQ-CON-008 | No inferred high-risk owner policy | FLOW-001, FLOW-003, FLOW-010, FLOW-015 | CTRL-AUTH-001, CTRL-INPUT-TRUST-001, CTRL-ACTION-001, CTRL-TOOL-001 | TEST-AUTHORIZATION-MATRIX, TEST-PROMPT-INJECTION, TEST-ACTION-CONFIRMATION, TEST-TOOL-ALLOWLIST, TEST-DEVICE-SIDE-EFFECT |
| REQ-ACC-001 | UI-configurable, safe test, destination-transparent, offline-tolerant, redacted acceptance | FLOW-001, FLOW-003, FLOW-006, FLOW-007, FLOW-010, FLOW-011, FLOW-013, FLOW-015 | CTRL-AUTH-001, CTRL-PRIVACY-001, CTRL-INPUT-TRUST-001, CTRL-PROVIDER-001, CTRL-ACTION-001, CTRL-RED-001, CTRL-IDEMPOTENCY-001, CTRL-RATE-001, CTRL-SUPPLY-CHAIN-001 | TEST-AUTHORIZATION-MATRIX, TEST-CLOUD-PRIVACY, TEST-PROMPT-INJECTION, TEST-PROVIDER-CONTRACT, TEST-ACTION-CONFIRMATION, TEST-DEVICE-SIDE-EFFECT, TEST-REDACTION-CANARY, TEST-IDEMPOTENT-RESTART, TEST-STORM-CONCURRENCY, TEST-DEPENDENCY-REVIEW |
